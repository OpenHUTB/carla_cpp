...
namespace carla_msgs {
    namespace msg {
        /*!  
         * @brief 此类表示用户在 IDL 文件中定义的结构 CarlaEgoVehicleControl。  
        ...
        public:
            ...
            /*!
             * @brief 复制构造函数。
             * @param x 将要被复制的 carla_msgs::msg::CarlaEgoVehicleControl 对象的引用。
             */
            eProsima_user_DllExport CarlaEgoVehicleControl(
            ...
            /*!  
             * @brief 该函数复制成员 header 中的值  
             * @param _header 要复制到成员 header 中的新值  
             */
            eProsima_user_DllExport void header(
                    const std_msgs::msg::Header& _header);

            /*!  
             * @brief 该函数移动成员 header 中的值  
             * @param _header 要移动到成员 header 中的新值  
             */  
            eProsima_user_DllExport void header(
